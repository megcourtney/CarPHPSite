...
<html>
    ...
    <body>
        <div class="login">
            ...
            <div class="item">
                <label> Password: </label> <input onkeydown="maybe_login(event);" class="input" name="password" type="password">
            </div>
                <div class="item">
                    <img id="loading" class="loading_hidden" src="images/loading.gif"><div class="button" onclick="login();">Login</div>
                </div>
            </form>
